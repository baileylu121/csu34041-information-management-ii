...
_Memorise these tables and definitions. In the exam, you'll need to recall them quickly to build your answers — ER diagrams, SQL statements, constraint analysis, and GDPR scenarios all depend on knowing these facts by heart._
